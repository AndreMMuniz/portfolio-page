...
const dictionary: Record<string, Record<string, string>> = {
    en: {
        ...
        "domain2.desc": "Building stateful, multi-agent systems with LangGraph. From autonomous research loops to complex human-in-the-loop enterprise workflows.",
        "domain2.flagship": "AGENTIC WORKFLOWS",
        "domain2.link": "Explore Documentation",
        "domain2.tech": "Technologies I Work With",
        "domain2.bullet1": "Multi-Agent Orchestration",
        "domain2.bullet2": "Self-Correcting RAG Systems",
        "domain2.bullet3": "Human-in-the-Loop Interactivity",
    ...
    pt: {
        ...
        "domain2.desc": "Construindo sistemas multi-agentes persistentes com LangGraph. De loops de pesquisa autônomos a workflows corporativos complexos com supervisão humana.",
        "domain2.flagship": "WORKFLOWS AGÊNTICOS",
        "domain2.link": "Explorar Documentação",
        "domain2.tech": "Tecnologias com as quais trabalho",
        "domain2.bullet1": "Orquestração de Múltiplos Agentes",
        "domain2.bullet2": "Sistemas RAG com Auto-Correção",
        "domain2.bullet3": "Interatividade Human-in-the-Loop",
