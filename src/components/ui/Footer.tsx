...
export default function Footer() {
    return (
        <footer className="w-full bg-[#0a0f0f] border-t border-slate-800 py-12">
            <div className="max-w-[1280px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-500 font-medium">© {new Date().getFullYear()} Andre Muniz | Next.js Engine. All rights reserved.</span>
                </div>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <Link href="https://bubble.io" target="_blank" className="text-slate-400 hover:text-primary transition-colors text-sm font-medium">
                        Bubble.io Profile
                    </Link>
                </div>
            </div>
