  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={onClose}>
      <div className="glass-panel max-w-md w-full mx-4 p-8 relative animate-in fade-in" onClick={(e) => e.stopPropagation()}>
        ...
        <a href="mailto:m.andremuniz@gmail.com" onClick={() => trackEvent("contact_click", { method: "email" })} className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:border-bubble-cyan/50 hover:bg-bubble-cyan/5 transition-all mb-4 group">
        ...
        <a href="https://wa.me/5513996118059" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent("contact_click", { method: "whatsapp" })} className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:border-green-500/50 hover:bg-green-500/5 transition-all group">
        ...
        <section className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center min-h-[70vh]">
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <Link onClick={() => trackEvent("hero_topic_click", { topic: "bubble" })} className="group flex items-center gap-3 px-6 py-3 rounded-xl bg-bubble-cyan/10 border border-bubble-cyan/20 hover:bg-bubble-cyan/20 hover:border-bubble-cyan/50 transition-all" href="#bubble">
              ...
              <Link onClick={() => trackEvent("hero_topic_click", { topic: "ai" })} className="group flex items-center gap-3 px-6 py-3 rounded-xl bg-ai-purple/10 border border-ai-purple/20 hover:bg-ai-purple/20 hover:border-ai-purple/50 transition-all" href="#ai">
        ...
        <section className="w-full max-w-7xl mx-auto scroll-mt-24" id="bubble">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
              {PLUGINS.map((plugin) => (
                <a key={plugin.title} href={plugin.href} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent("plugin_click", { plugin: plugin.title })} className="glass-panel group p-1 hover:border-bubble-cyan/40 transition-colors duration-500 cursor-pointer">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 max-w-lg gap-6">
              {TEMPLATES.map((tmpl) => (
                <a key={tmpl.title} href={tmpl.href} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent("template_click", { template: tmpl.title })} className="glass-panel group p-1 hover:border-bubble-cyan/40 transition-colors duration-500 cursor-pointer">
      ...
      <footer className="border-t border-white/5 bg-black/40 backdrop-blur-md py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 items-center">
            <button
              onClick={() => {
                trackEvent("translation_choice", { choice: language === 'en' ? 'pt' : 'en', auto_prompt: false });
